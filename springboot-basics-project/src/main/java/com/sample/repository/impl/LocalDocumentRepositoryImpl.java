...
@Repository
public class LocalDocumentRepositoryImpl implements DocumentRepository {
    ...
    public void upload(DocumentDetails document) {
        ...
        System.out.println("Test Uploading document: " + document.getFilename());
    ...
    public void download(Long documentId) {
        ...
        System.out.println("Test Downloading document with ID: " + documentId);
    }
    ...
    public void update(DocumentDetails document) {
        ...
        if (documentMap.containsKey(document.getId())) {
            documentMap.put(document.getId(), document);
            System.out.println("Test Document updated: " + document.getFilename());
        } else {
            System.out.println("Test Document not found for update with ID: " + document.getId());
        }
    }
}